...
// import Radium, { StyleRoot }  from 'radium'; //check the LAST line
...
const StyledButton = styled.button`
  background-color: ${props => props.changeColor ? 'red' : 'green'};
  font: inherit;
  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        <StyledButton             ///////////////////////////////////////////////////
          switchColor={this.state.showPersons} //just an argument 
                                              //(check how it's used in StyledButton CSS)
